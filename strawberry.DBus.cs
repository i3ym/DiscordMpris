namespace strawberry.DBus
{
    ...
    partial class MediaPlayer2 : strawberryObject
    {
        private const string __Interface = "org.mpris.MediaPlayer2";
        public MediaPlayer2(strawberryService service, ObjectPath path) : base(service, path)
        { }
        ...
        public Task<bool> GetCanQuitAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "CanQuit"), (Message m, object? s) => ReadMessage_v_b(m, (strawberryObject)s!), this);
        public Task<bool> GetCanRaiseAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "CanRaise"), (Message m, object? s) => ReadMessage_v_b(m, (strawberryObject)s!), this);
        public Task<bool> GetHasTrackListAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "HasTrackList"), (Message m, object? s) => ReadMessage_v_b(m, (strawberryObject)s!), this);
        public Task<string> GetIdentityAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "Identity"), (Message m, object? s) => ReadMessage_v_s(m, (strawberryObject)s!), this);
        public Task<string> GetDesktopEntryAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "DesktopEntry"), (Message m, object? s) => ReadMessage_v_s(m, (strawberryObject)s!), this);
        public Task<string[]> GetSupportedUriSchemesAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "SupportedUriSchemes"), (Message m, object? s) => ReadMessage_v_as(m, (strawberryObject)s!), this);
        public Task<string[]> GetSupportedMimeTypesAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "SupportedMimeTypes"), (Message m, object? s) => ReadMessage_v_as(m, (strawberryObject)s!), this);
        public Task<bool> GetFullscreenAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "Fullscreen"), (Message m, object? s) => ReadMessage_v_b(m, (strawberryObject)s!), this);
        public Task<bool> GetCanSetFullscreenAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "CanSetFullscreen"), (Message m, object? s) => ReadMessage_v_b(m, (strawberryObject)s!), this);
        public Task<MediaPlayer2Properties> GetPropertiesAsync()
        {
            return this.Connection.CallMethodAsync(CreateGetAllPropertiesMessage(__Interface), (Message m, object? s) => ReadMessage(m, (strawberryObject)s!), this);
            static MediaPlayer2Properties ReadMessage(Message message, strawberryObject _)
            {
        ...
        {
            return base.WatchPropertiesChangedAsync(__Interface, (Message m, object? s) => ReadMessage(m, (strawberryObject)s!), handler, emitOnCapturedContext, flags);
            static PropertyChanges<MediaPlayer2Properties> ReadMessage(Message message, strawberryObject _)
            {
                var reader = message.GetBodyReader();
    ...
    partial class Player : strawberryObject
    {
        private const string __Interface = "org.mpris.MediaPlayer2.Player";
        public Player(strawberryService service, ObjectPath path) : base(service, path)
        { }
        ...
        public ValueTask<IDisposable> WatchSeekedAsync(Action<Exception?, long> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "Seeked", (Message m, object? s) => ReadMessage_x(m, (strawberryObject)s!), handler, emitOnCapturedContext, flags);
        ...
        public Task SetRatingAsync(double value)
        {
            return this.Connection.CallMethodAsync(CreateMessage());
            MessageBuffer CreateMessage()
            {
        ...
        public Task<string> GetPlaybackStatusAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "PlaybackStatus"), (Message m, object? s) => ReadMessage_v_s(m, (strawberryObject)s!), this);
        public Task<string> GetLoopStatusAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "LoopStatus"), (Message m, object? s) => ReadMessage_v_s(m, (strawberryObject)s!), this);
        public Task<double> GetRateAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "Rate"), (Message m, object? s) => ReadMessage_v_d(m, (strawberryObject)s!), this);
        public Task<bool> GetShuffleAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "Shuffle"), (Message m, object? s) => ReadMessage_v_b(m, (strawberryObject)s!), this);
        public Task<Dictionary<string, VariantValue>> GetMetadataAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "Metadata"), (Message m, object? s) => ReadMessage_v_aesv(m, (strawberryObject)s!), this);
        public Task<double> GetRatingAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "Rating"), (Message m, object? s) => ReadMessage_v_d(m, (strawberryObject)s!), this);
        public Task<double> GetVolumeAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "Volume"), (Message m, object? s) => ReadMessage_v_d(m, (strawberryObject)s!), this);
        public Task<long> GetPositionAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "Position"), (Message m, object? s) => ReadMessage_v_x(m, (strawberryObject)s!), this);
        public Task<double> GetMinimumRateAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "MinimumRate"), (Message m, object? s) => ReadMessage_v_d(m, (strawberryObject)s!), this);
        public Task<double> GetMaximumRateAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "MaximumRate"), (Message m, object? s) => ReadMessage_v_d(m, (strawberryObject)s!), this);
        public Task<bool> GetCanGoNextAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "CanGoNext"), (Message m, object? s) => ReadMessage_v_b(m, (strawberryObject)s!), this);
        public Task<bool> GetCanGoPreviousAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "CanGoPrevious"), (Message m, object? s) => ReadMessage_v_b(m, (strawberryObject)s!), this);
        public Task<bool> GetCanPlayAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "CanPlay"), (Message m, object? s) => ReadMessage_v_b(m, (strawberryObject)s!), this);
        public Task<bool> GetCanPauseAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "CanPause"), (Message m, object? s) => ReadMessage_v_b(m, (strawberryObject)s!), this);
        public Task<bool> GetCanSeekAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "CanSeek"), (Message m, object? s) => ReadMessage_v_b(m, (strawberryObject)s!), this);
        public Task<bool> GetCanControlAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "CanControl"), (Message m, object? s) => ReadMessage_v_b(m, (strawberryObject)s!), this);
        public Task<PlayerProperties> GetPropertiesAsync()
        {
            return this.Connection.CallMethodAsync(CreateGetAllPropertiesMessage(__Interface), (Message m, object? s) => ReadMessage(m, (strawberryObject)s!), this);
            static PlayerProperties ReadMessage(Message message, strawberryObject _)
            {
                var reader = message.GetBodyReader();
                return ReadProperties(ref reader);
            }
        ...
        {
            return base.WatchPropertiesChangedAsync(__Interface, (Message m, object? s) => ReadMessage(m, (strawberryObject)s!), handler, emitOnCapturedContext, flags);
            static PropertyChanges<PlayerProperties> ReadMessage(Message message, strawberryObject _)
            {
                var reader = message.GetBodyReader();
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
            ...
            static string[] ReadInvalidated(ref Reader reader)
            {
                ...
                while (reader.HasNext(arrayEnd))
                {
                    ...
                    switch (property)
                    {
                        ...
                        case "Rating": invalidated.Add("Rating"); break;
        ...
        private static PlayerProperties ReadProperties(ref Reader reader, List<string>? changedList = null)
        {
            ...
            while (reader.HasNext(arrayEnd))
            {
                ...
                switch (property)
                {
                    ...
                    case "Rating":
                        reader.ReadSignature("d");
                        props.Rating = reader.ReadDouble();
                        changedList?.Add("Rating");
                        break;
                    case "Volume":
                        reader.ReadSignature("d");
    ...
    partial class Playlists : strawberryObject
    {
        private const string __Interface = "org.mpris.MediaPlayer2.Playlists";
        public Playlists(strawberryService service, ObjectPath path) : base(service, path)
        { }
        ...
        {
            return this.Connection.CallMethodAsync(CreateMessage(), (Message m, object? s) => ReadMessage_arossz(m, (strawberryObject)s!), this);
            MessageBuffer CreateMessage()
            {
                var writer = this.Connection.GetMessageWriter();
                writer.WriteMethodCallHeader(
        ...
        public ValueTask<IDisposable> WatchPlaylistChangedAsync(Action<Exception?, (ObjectPath, string, string)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "PlaylistChanged", (Message m, object? s) => ReadMessage_rossz(m, (strawberryObject)s!), handler, emitOnCapturedContext, flags);
        ...
        public Task<uint> GetPlaylistCountAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "PlaylistCount"), (Message m, object? s) => ReadMessage_v_u(m, (strawberryObject)s!), this);
        public Task<string[]> GetOrderingsAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "Orderings"), (Message m, object? s) => ReadMessage_v_as(m, (strawberryObject)s!), this);
        public Task<(bool, (ObjectPath, string, string))> GetActivePlaylistAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "ActivePlaylist"), (Message m, object? s) => ReadMessage_v_rbrosszz(m, (strawberryObject)s!), this);
        public Task<PlaylistsProperties> GetPropertiesAsync()
        {
            return this.Connection.CallMethodAsync(CreateGetAllPropertiesMessage(__Interface), (Message m, object? s) => ReadMessage(m, (strawberryObject)s!), this);
            static PlaylistsProperties ReadMessage(Message message, strawberryObject _)
            {
                var reader = message.GetBodyReader();
                return ReadProperties(ref reader);
            }
        ...
        {
            return base.WatchPropertiesChangedAsync(__Interface, (Message m, object? s) => ReadMessage(m, (strawberryObject)s!), handler, emitOnCapturedContext, flags);
            static PropertyChanges<PlaylistsProperties> ReadMessage(Message message, strawberryObject _)
            {
                var reader = message.GetBodyReader();
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
    ...
    partial class TrackList : strawberryObject
    {
        private const string __Interface = "org.mpris.MediaPlayer2.TrackList";
        public TrackList(strawberryService service, ObjectPath path) : base(service, path)
        { }
        public Task<Dictionary<string, VariantValue>[]> GetTracksMetadataAsync(ObjectPath[] trackIds)
        {
            return this.Connection.CallMethodAsync(CreateMessage(), (Message m, object? s) => ReadMessage_aaesv(m, (strawberryObject)s!), this);
            MessageBuffer CreateMessage()
            {
                var writer = this.Connection.GetMessageWriter();
                writer.WriteMethodCallHeader(
        ...
        public ValueTask<IDisposable> WatchTrackListReplacedAsync(Action<Exception?, (ObjectPath[] Tracks, ObjectPath CurrentTrack)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "TrackListReplaced", (Message m, object? s) => ReadMessage_aoo(m, (strawberryObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchTrackAddedAsync(Action<Exception?, (Dictionary<string, VariantValue> Metadata, ObjectPath AfterTrack)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "TrackAdded", (Message m, object? s) => ReadMessage_aesvo(m, (strawberryObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchTrackRemovedAsync(Action<Exception?, ObjectPath> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "TrackRemoved", (Message m, object? s) => ReadMessage_o(m, (strawberryObject)s!), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchTrackMetadataChangedAsync(Action<Exception?, (ObjectPath TrackId, Dictionary<string, VariantValue> Metadata)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "TrackMetadataChanged", (Message m, object? s) => ReadMessage_oaesv(m, (strawberryObject)s!), handler, emitOnCapturedContext, flags);
        ...
        public Task<ObjectPath[]> GetTracksAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "Tracks"), (Message m, object? s) => ReadMessage_v_ao(m, (strawberryObject)s!), this);
        public Task<bool> GetCanEditTracksAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "CanEditTracks"), (Message m, object? s) => ReadMessage_v_b(m, (strawberryObject)s!), this);
        public Task<TrackListProperties> GetPropertiesAsync()
        {
            return this.Connection.CallMethodAsync(CreateGetAllPropertiesMessage(__Interface), (Message m, object? s) => ReadMessage(m, (strawberryObject)s!), this);
            static TrackListProperties ReadMessage(Message message, strawberryObject _)
            {
                var reader = message.GetBodyReader();
                return ReadProperties(ref reader);
            }
        ...
        {
            return base.WatchPropertiesChangedAsync(__Interface, (Message m, object? s) => ReadMessage(m, (strawberryObject)s!), handler, emitOnCapturedContext, flags);
            static PropertyChanges<TrackListProperties> ReadMessage(Message message, strawberryObject _)
            {
                var reader = message.GetBodyReader();
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
    ...
    partial class strawberryService
    {
        public Tmds.DBus.Protocol.Connection Connection { get; }
        public string Destination { get; }
        public strawberryService(Tmds.DBus.Protocol.Connection connection, string destination)
    ...
    {
        public strawberryService Service { get; }
        public ObjectPath Path { get; }
        protected Tmds.DBus.Protocol.Connection Connection => Service.Connection;
        protected strawberryObject(strawberryService service, ObjectPath path)
        ...
        protected static bool ReadMessage_v_b(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
            reader.ReadSignature("b");
            return reader.ReadBool();
        }
        protected static string ReadMessage_v_s(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
            reader.ReadSignature("s");
            return reader.ReadString();
        }
        protected static string[] ReadMessage_v_as(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
            reader.ReadSignature("as");
            return reader.ReadArrayOfString();
        }
        protected static long ReadMessage_x(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
            return reader.ReadInt64();
        }
        protected static double ReadMessage_v_d(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
            reader.ReadSignature("d");
            return reader.ReadDouble();
        }
        protected static Dictionary<string, VariantValue> ReadMessage_v_aesv(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
            reader.ReadSignature("a{sv}");
            return reader.ReadDictionaryOfStringToVariantValue();
        }
        protected static long ReadMessage_v_x(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
            reader.ReadSignature("x");
            return reader.ReadInt64();
        }
        protected static (ObjectPath, string, string)[] ReadMessage_arossz(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
            return ReadType_arossz(ref reader);
        }
        protected static (ObjectPath, string, string) ReadMessage_rossz(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
            return ReadType_rossz(ref reader);
        }
        protected static uint ReadMessage_v_u(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
            reader.ReadSignature("u");
            return reader.ReadUInt32();
        }
        protected static (bool, (ObjectPath, string, string)) ReadMessage_v_rbrosszz(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
            reader.ReadSignature("(b(oss))");
            return ReadType_rbrosszz(ref reader);
        }
        protected static Dictionary<string, VariantValue>[] ReadMessage_aaesv(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
            return ReadType_aaesv(ref reader);
        }
        protected static (ObjectPath[], ObjectPath) ReadMessage_aoo(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
        ...
        protected static (Dictionary<string, VariantValue>, ObjectPath) ReadMessage_aesvo(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
        ...
        protected static ObjectPath ReadMessage_o(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
            return reader.ReadObjectPath();
        }
        protected static (ObjectPath, Dictionary<string, VariantValue>) ReadMessage_oaesv(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
        ...
        protected static ObjectPath[] ReadMessage_v_ao(Message message, strawberryObject _)
        {
            var reader = message.GetBodyReader();
            reader.ReadSignature("ao");
